  ...
  return (
    <Fragment>
      <Metas
        data={{
          ...metaData,
          image: 'https://res.cloudinary.com/iobami/image/upload/v1641251787/nfts/openc_cjr7vl.png',
      ...
      <section className={`asset-details-section ${theme}`}>
        <div className="asset-details-section__wrapper pt-20 lg:pt-3 lg:flex flex-row">
          <div className="lg:w-5/12 px-3  mb-8">
            ...
            <LazyLoadImage alt={item.node.name} className="asset-details-section__asset-img mb-3" height={440} width="100%" placeholderSrc="/imgs/skeleton.gif" src={item.node.banner} />
